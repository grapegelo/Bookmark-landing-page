...
question1.addEventListener("click", function () {
  faq1.classList.toggle("openFaq");
  faq1.classList.toggle("faqAnswer");
});
question2.addEventListener("click", function () {
  faq2.classList.toggle("openFaq");
  faq2.classList.toggle("faqAnswer");
});
question3.addEventListener("click", function () {
  faq3.classList.toggle("openFaq");
  faq3.classList.toggle("faqAnswer");
});
question4.addEventListener("click", function () {
  faq4.classList.toggle("openFaq");
  faq4.classList.toggle("faqAnswer");
});
